...
// API URL &  HOST URL
export const API_URL = (process.env.NODE_ENV === 'production') ? 'http://localhost:5000' : 'http://localhost:5000';
...
const LINKEDIN_RIDERECT = (process.env.NODE_ENV === 'production') ? 'http://18.219.23.231/callback' : 'http://localhost:3000/callback';
